...
function Signup() {
    ...
    return (
        <>
            ...
            <div className={`${isLoading ? 'scale-[1.2] opacity-0' : ''} w-full h-screen py-6 bg-white fixed top-0 left-0`}>
                    ...
                    <div className="w-full h-[50%] overflow-hidden rounded-xl shadow-sm bg-cover bg-[url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/signup-cover.jpg')]">
                        <div className="w-full h-full bg-gray-600/[.6] flex">
                            <div className="mx-auto mt-[6rem] text-center w-[450px]">
                                <h1 className="drop-shadow-md lg:text-5xl text-4xl mb-4 font-bold text-white">Welcome!</h1>
                                <p className="text-white text-lg">Use these awesome forms to login or create new account in your project for free.</p>
                            </div>
                        </div>
                    </div>
                    <div className="sm:w-[450px] w-[80%] absolute top-[60%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-white px-6 py-10 shadow-xl rounded-[40px]">
                        <h1 className="text-3xl text-center mb-8 font-semibold text-slate-700">Register With Me</h1>
                        <form onSubmit={handlerSubmitForm} className="w-full">
                            ...
                            <div className="flex gap-2 my-6">
                                ...
                                <p className="text-slate-500">I agree the <span><a className="cursor-pointer text-[#cf3bed]">Terms and Conditions</a></span></p>
                            </div>
                            <Button
                                type={'submit'}
                                ...
                                isShowTitle={true}
                            />
                            <p className="text-slate-500">Already have an account? <span><Link to='/login' className="text-[#cf3bed]">Login</Link></span></p>
                        </form>
                    </div>
                    <p className="absolute bottom-8 left-1/2 -translate-x-1/2 text-slate-500 text-center">Copyright © 2025</p>
                </div>
            </div>
            {
